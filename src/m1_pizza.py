...
def run_test_generate_points_on_circle():
    ...
    # ------------------------------------------------------------------
    expected = [rg.Point(4,4),
                rg.Point(0,4)]
    circle = rg.Circle(rg.Point(2,4),2)
...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = "Test 4: 36 purple on filled"
    window = rg.RoseWindow(400,400, title)
    circle = rg.Circle(rg.Point(300,300),200)
    circle.fill_color = 'blue'
    draw_points_on_circle(window, circle, 36, 'purple')
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    window = rg.RoseWindow(550,400,title)
    circle = rg.Circle(rg.Point(150,75), 100)
    circle.outline_thickness = 4
    polygon(window,circle,40,'blue', 10)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    circle.fill_color = 'yellow'
    fancy_polygon(window,circle,8,2,'green',2)
    window.close_on_mouse_click()
    # ------------------------------------------------------------------
    # Test 4:  (YOU write THIS test).
